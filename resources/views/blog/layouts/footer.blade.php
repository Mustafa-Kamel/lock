...
<footer class="main-footer">
    ...
    <div class="copyrights">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p>Copyrights &copy; {{ date('Y') }}. All rights reserved. <a href="http://www.mustafakamel.tk">Mustafa Waley</a>.</p>
                </div>
                <div class="col-md-6 text-right">
                    <p><small>Template By <a href="https://bootstraptemple.com" class="text-white">BS-Temple</a></small></p>
                </div>
            </div>
        </div>
    </div>
...
<script src="{{ asset('vendor/bootstrap/js/bootstrap-'.LaravelLocalization::getCurrentLocaleDirection().'.min.js') }}"></script>
